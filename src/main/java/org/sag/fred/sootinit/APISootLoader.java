...
public class APISootLoader extends SootLoader {
	...
	private String in;
	private IFredDataAccessor dataAccessor;
	...
	public boolean load(IFredDataAccessor dataAccessor, Path pathToInput, int javaVersion, ILogger logger) {
