...
public class FileMethodsDatabase extends FileHashDatabase implements IFileMethodsDatabase {
	...
	public static void main(String[] args) throws Exception {
		FileMethodsDatabase db = readXMLStatic("C:\\CS\\Documents\\Work\\Research\\fred\\aosp-10.0.0\\fred\\file_methods_db.xml", null);
		int android = 0;
		int java = 0;
		...
		/*FileMethodsDatabase fullRunDB = readXMLStatic("C:\\CS\\Documents\\Work\\Research\\fred\\aosp-9.0.0\\input\\fred\\file_methods_db__.xml", null);
		FileMethodsDatabase imdRunDB = readXMLStatic("C:\\CS\\Documents\\Work\\Research\\fred\\aosp-9.0.0\\input\\fred\\file_methods_db.xml", null);
