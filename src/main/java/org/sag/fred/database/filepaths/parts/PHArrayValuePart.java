...
@XStreamAlias("PHArrayValuePart")
public class PHArrayValuePart extends PHPart {
	...
	@XStreamOmitField
	private volatile DefinitionStmt stmt;
	@XStreamOmitField
	private volatile String cacheString;
	@XStreamOmitField
	private volatile String cacheLogString;
	
	public PHArrayValuePart(DefinitionStmt stmt, SootMethod sourceMethod) {
	...
	public DefinitionStmt getStmt() {
		if(stmt == null)
			stmt = (DefinitionStmt)source.toUnit();
		return stmt;
	}
	...
	public boolean equals(Object o) {
		return super.equals(o) && Objects.equals(source, ((PHArrayValuePart)o).source);
	}
	...
	public String toLogString(String spacer) {
		if(cacheLogString == null) {
			...
			sb.append(spacer).append("Source: ").append(source.getSource().getSignature()).append("\n");
			sb.append(spacer).append("Stmt: ").append(source.getSignature()).append("\n");
	...
	public int compareTo(LeafPart o) {
		if(getClass() == o.getClass()) {
			return source.compareTo(((PHArrayValuePart)o).source);
		} else {
	...
	@Override
	public PHArrayValuePart readXML(String filePath, Path path) throws Exception {
		throw new UnsupportedOperationException();
	}
	...
	public static class XStreamSetup extends AbstractXStreamSetup {
		...
		public Set<Class<?>> getAnnotatedClasses() {
			return Collections.singleton(PHArrayValuePart.class);
		}
