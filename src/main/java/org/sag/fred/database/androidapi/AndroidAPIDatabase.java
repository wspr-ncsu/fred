...
@XStreamAlias("AndroidAPIDatabase")
public class AndroidAPIDatabase extends FileHashDatabase implements IAndroidAPIDatabase {
	...
	protected AndroidAPIDatabase(boolean newDB) {
		if(newDB) {
	...
	@Override
	public AndroidAPIDatabase readXML(String filePath, Path path) throws Exception {
		rwlock.writeLock().lock();
		try {
	...
	public static AndroidAPIDatabase readXMLStatic(String filePath, Path path) throws Exception {
		return new AndroidAPIDatabase(false).readXML(filePath, path);
	}
	...
	public static class SubXStreamSetup extends XStreamSetup {
		...
		public Set<Class<?>> getAnnotatedClasses() {
			return Collections.singleton(AndroidAPIDatabase.class);
		}
