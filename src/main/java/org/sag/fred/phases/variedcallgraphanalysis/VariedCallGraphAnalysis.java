package org.sag.fred.phases.variedcallgraphanalysis;
...
public class VariedCallGraphAnalysis {
	...
	public boolean run() {
		...
		if(dumpnative) {
			Path dumpFile = dataAccessor.getConfig().getFilePath("debug_fred-eps-to-native-methods-dump-file");
			Path dumpFile2 = dataAccessor.getConfig().getFilePath("debug_fred-native-methods-from-eps-dump-file");
	...
	public static void main(String[] args) throws IOException {
		BufferedReader br = Files.newBufferedReader(FileHelpers.getPath("C:\\CS\\Documents\\Work\\Research\\fred\\aosp-10.0.0\\debug\\2020-05-30_11-59-26\\fred_eps_to_native_methods_dump.txt"));
		String ln;
		...
		br = Files.newBufferedReader(FileHelpers.getPath("C:\\CS\\Documents\\Work\\Research\\fred\\aosp-10.0.0\\debug\\2020-05-30_11-04-26\\eps_to_native_methods_dump.txt"));
		...
		try(PrintStream ps = new PrintStreamUnixEOL(Files.newOutputStream(FileHelpers.getPath("C:\\CS\\Documents\\Work\\Research\\fred\\aosp-10.0.0\\debug\\test.txt")))) {
			for(String ep : epsToNative.keySet()) {
				ps.println(ep);
