package org.sag.woof.database.messagehandlers;
...
@XStreamAlias("EmptyMessageHandlerDatabase")
public class EmptyMessageHandlerDatabase implements IMessageHandlerDatabase {
	...
	@Override
	public EmptyMessageHandlerDatabase readXML(String filePath, Path path) throws Exception {
		return XStreamInOut.readXML(this, filePath, path);
	}
	
	public static EmptyMessageHandlerDatabase readXMLStatic(String filePath, Path path) throws Exception {
		return new EmptyMessageHandlerDatabase().readXML(filePath, path);
	}
	...
	public static class SubXStreamSetup extends XStreamSetup {
		...
		public Set<Class<?>> getAnnotatedClasses() {
			return Collections.singleton(EmptyMessageHandlerDatabase.class);
		}
