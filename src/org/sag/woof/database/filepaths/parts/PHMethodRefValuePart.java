...
@XStreamAlias("PHMethodRefValuePart")
public class PHMethodRefValuePart extends PHPart {
	
	@XStreamAlias("Source")
	private volatile SootUnitContainer source;
	
	@XStreamOmitField
	private volatile DefinitionStmt invokeStmt;
	@XStreamOmitField
	...
	public PHMethodRefValuePart(DefinitionStmt invokeStmt, SootMethod invokeSource) {
	...
	public DefinitionStmt getInvokeStmt() {
		if(invokeStmt == null)
			invokeStmt = (DefinitionStmt)source.toUnit();
		return invokeStmt;
	}
	...
	public boolean equals(Object o) {
		return super.equals(o) && Objects.equals(source, ((PHMethodRefValuePart)o).source);
	}
	...
	public String getAnalysisName() {
		return "MethodRef Value Analysis";
	}
	...
	public int compareTo(LeafPart o) {
		if(getClass() == o.getClass()) {
			return source.compareTo(((PHMethodRefValuePart)o).source);
		} else {
	...
	public Set<Triple<SootMethod, Stmt, Value>> getStartPoints(IJimpleICFG icfg) {
		return Collections.singleton(new Triple<>(getInvokeSource(), getInvokeStmt(), getInvokeStmt().getLeftOp()));
	}
	
	@Override
	public Set<DefinitionStmt> getDefs(IJimpleICFG icfg, SootMethod sourceMethod, Stmt stmt, Value v) {
		return Collections.singleton(getInvokeStmt());
	}
	...
	@Override
	public PHMethodRefValuePart readXML(String filePath, Path path) throws Exception {
		throw new UnsupportedOperationException();
	}
	...
	public static class XStreamSetup extends AbstractXStreamSetup {
		...
		public Set<Class<?>> getAnnotatedClasses() {
			return Collections.singleton(PHMethodRefValuePart.class);
		}
